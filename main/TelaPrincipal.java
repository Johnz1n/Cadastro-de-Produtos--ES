...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       p.setValor(Float.parseFloat(txtValor.getText()));
        ...
        try {
            ...
            val.addRow(new String [] {Integer.toString(p.getCodigo()), p.getNome(), p.getUnindade(), p.getTipo(), Float.toString(p.getValor())});
        } catch (Exception ex) {
           ErroD dialog;
           dialog = new ErroD();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for(Produto m: produtos){
            DefaultTableModel val = (DefaultTableModel) tp.getModel();
            val.addRow(new String [] {Integer.toString(m.getCodigo()), m.getNome(), m.getUnindade(), m.getTipo(), Float.toString(m.getValor())});
        }
